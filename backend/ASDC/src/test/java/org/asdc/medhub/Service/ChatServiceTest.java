...
@ContextConfiguration(classes = {ChatService.class, User.class})
...
public class ChatServiceTest {
    ...
    /**
     * Method under test:
     * {@link ChatService#getConversationBetweenTwoUsers(String, String)}
     */
    @Test
    public void testGetConversationBetweenTwoUsers() {
        // Arrange
        ArrayList<Chat> chatList = new ArrayList<>();
        when(chatRepository.findChatMessagesBetweenTwoUsers(Mockito.<String>any(), Mockito.<String>any()))
                .thenReturn(chatList);

        // Act
        ResponseModel<List<ChatDetail>> actualConversationBetweenTwoUsers = chatService
                .getConversationBetweenTwoUsers("User Id1", "User Id2");

        // Assert
        verify(chatRepository).findChatMessagesBetweenTwoUsers(eq("User Id1"), eq("User Id2"));
        assertEquals("Conversation found", actualConversationBetweenTwoUsers.getMessage());
        assertTrue(actualConversationBetweenTwoUsers.isSuccess());
        assertEquals(chatList, actualConversationBetweenTwoUsers.getResponseData());
    }
     ...
     */
    @Test
    public void testGetConversationBetweenTwoUsers2() {
        // Arrange
        Chat chat = new Chat();
        chat.setContent("Not all who wander are lost");
        chat.setCreatedAt(mock(Timestamp.class));
        chat.setId(1L);
        chat.setReceiverId("42");
        chat.setSenderId("42");
        ...
        // Assert
        verify(chatRepository).findChatMessagesBetweenTwoUsers(eq("User Id1"), eq("User Id2"));
        List<ChatDetail> responseData = actualConversationBetweenTwoUsers.getResponseData();
        assertEquals(1, responseData.size());
        ChatDetail getResult = responseData.get(0);
        assertEquals("42", getResult.getReceiverId());
        assertEquals("42", getResult.getSenderId());
        assertEquals("Conversation found", actualConversationBetweenTwoUsers.getMessage());
     ...
     */
    @Test
    public void testGetConversationBetweenTwoUsers3() {
        // Arrange
        when(chatRepository.findChatMessagesBetweenTwoUsers(Mockito.<String>any(), Mockito.<String>any()))
                .thenThrow(new RuntimeException("Conversation found"));
        ...
        // Assert
        verify(chatRepository).findChatMessagesBetweenTwoUsers(eq("User Id1"), eq("User Id2"));
        assertEquals("Failed to retrieve conversation: Conversation found", actualConversationBetweenTwoUsers.getMessage());
    }

    /**
     * Method under test: {@link ChatService#getUsername(User)}
     */
    @Test
    public void testGetUsername() {
        ...
        user2.setPharmacist(pharmacist);
        ...
        // Act
        ResponseModel<String> actualUsername = chatService.getUsername(user5);

        // Assert
        assertEquals("Current user username", actualUsername.getMessage());
        assertEquals("janedoe", actualUsername.getResponseData());
        assertTrue(actualUsername.isSuccess());
    }

    /**
     * Method under test: {@link ChatService#postMessage(String, String, String)}
     */
    @Test
    public void testPostMessage() {
        ...
        chat.setReceiverId("42");
        chat.setSenderId("42");
        when(chatRepository.save(Mockito.<Chat>any())).thenReturn(chat);

        // Act
        Chat actualPostMessageResult = chatService.postMessage("42", "42", "Not all who wander are lost");

        // Assert
        verify(chatRepository).save(Mockito.<Chat>any());
        assertSame(chat, actualPostMessageResult);
    }
    ...
    public void testPostMessage2() {
        // Arrange
        when(chatRepository.save(Mockito.<Chat>any())).thenThrow(new RuntimeException("foo"));

        // Act and Assert
        assertThrows(RuntimeException.class, () -> chatService.postMessage("42", "42", "Not all who wander are lost"));
        verify(chatRepository).save(Mockito.<Chat>any());
    }

    /**
     * Method under test: {@link ChatService#findAllChatPartnersByUserId(String)}
     */
    @Test
    public void testFindAllChatPartnersByUserId() {
        // Arrange
        ArrayList<String> stringList = new ArrayList<>();
        when(chatRepository.findAllChatPartnersByUserId(Mockito.<String>any())).thenReturn(stringList);

        // Act
        ResponseModel<List<UserDetail>> actualFindAllChatPartnersByUserIdResult = chatService
                .findAllChatPartnersByUserId("42");

        // Assert
        verify(chatRepository).findAllChatPartnersByUserId(eq("42"));
        assertEquals("Chat partners", actualFindAllChatPartnersByUserIdResult.getMessage());
        assertTrue(actualFindAllChatPartnersByUserIdResult.isSuccess());
        assertEquals(stringList, actualFindAllChatPartnersByUserIdResult.getResponseData());
    }
     ...
     */
    @Test
    public void testFindAllChatPartnersByUserId2() {
        // Arrange
        ArrayList<String> stringList = new ArrayList<>();
        stringList.add("Chat partners");
        when(chatRepository.findAllChatPartnersByUserId(Mockito.<String>any())).thenReturn(stringList);
        ...
        // Assert
        verify(chatRepository).findAllChatPartnersByUserId(eq("42"));
        verify(userRepository).findUserByUsername(eq("Chat partners"));
        assertEquals("Chat partners", actualFindAllChatPartnersByUserIdResult.getMessage());
        List<UserDetail> responseData = actualFindAllChatPartnersByUserIdResult.getResponseData();
        assertEquals(1, responseData.size());
        UserDetail getResult = responseData.get(0);
        assertEquals("Doe", getResult.getLastName());
        assertEquals("Jane", getResult.getFirstName());
        assertEquals("janedoe", getResult.getUsername());
        assertEquals(UserRole.DOCTOR, getResult.getUserRole());
        assertTrue(actualFindAllChatPartnersByUserIdResult.isSuccess());
    }
}
