...
public class PatientServiceTest {
    ...
    public MedicalSpecializationRepository medicalSpecRepo;
    ...
    public void InitializeTest(){
        ...
        this.medicalSpecRepo =Mockito.mock(MedicalSpecializationRepository.class);
