...
public class ProjectConstants {
    ...
    /**
     * Default start time of doctor to see appointments (if not set earlier)
     */
    public static final Timestamp defaultDoctorStartTime=Timestamp.valueOf(LocalDate.now().atTime(10, 0));

    /**
     * Default end time of doctor for appointments (if not set earlier)
     */
    public static final Timestamp defaultDoctorEndTime=Timestamp.valueOf(LocalDate.now().atTime(17, 0));

    /**
     * The message user gets via email notification when account verification is rejected by admin.
     */
    public static final String accountRejectedMessage="Oh no! Your account at MedHub could not be approved. Please email help@medhub.com from your registered email id for more info.";

    /**
     * The message user gets via email notification when account is verified/approved by admin.
     */
    public static final String accountApproveMessage="Congratulations! Your account at MedHub has been approved! Please click the link below to login\n\n%s/sign-in";

    /**
     * In bearer token string, index from which actual token start (here we need to ignore string 'Bearer ')
     */
    public static final int actualTokenStartIndex=7;
