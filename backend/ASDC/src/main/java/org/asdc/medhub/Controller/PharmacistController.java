...
public class PharmacistController {
    ...
    public ResponseEntity<ResponseModel<List<AppointmentDetail>>> getFilteredAppointments(@RequestParam("nameSearchString") String patientName, Authentication authentication){
        int pharmacistId=((User)authentication.getPrincipal()).getPharmacist().getId();
        return ResponseEntity.ok(this.pharmacistService.getAppointmentsFilteredByPatientName(patientName,pharmacistId));
    }
