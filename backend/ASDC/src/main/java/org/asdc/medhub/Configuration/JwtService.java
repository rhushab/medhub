    ...
    public String generateToken(String userName,String userId, UserRole role) {
        return   Jwts
                ...
                .issuedAt(new Date(System.currentTimeMillis()))
                 //Multiplying with 60 and 1000 to get seconds and milliseconds
                .expiration(new Date(System.currentTimeMillis() + (long) this.customConfigurations.tokenValidityInMinutes *60*1000 ))
