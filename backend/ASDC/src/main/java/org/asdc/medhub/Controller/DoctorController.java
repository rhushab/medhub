...
public class DoctorController {
    ...
    public ResponseEntity<ResponseModel<DoctorDetail>> getDoctorProfile(Authentication authentication) {
    ...
    public ResponseEntity<ResponseModel<String>> setEmailNotificationPreference(@RequestParam("preference") boolean emailNotificationPreference, Authentication authentication){
        String email = authentication.getName();
