...
public class PatientController {
    ...
    public ResponseEntity<ResponseModel<PatientDetail>> getPatientProfile(Authentication authentication) {
    ...
    public ResponseEntity<ResponseModel<String>> editPatientProfile(@Valid @RequestBody PatientDetail patientDetail, Authentication authentication) {
        String email = authentication.getName();
